...
_SECTOR_RULES = [
    ...
    ('证券',   ['证券', '券商', '资本']),
    ('保险',   ['保险', '人寿', '人保', '太平']),
    ('地产',   ['地产', '房产', '置业', '城建', '万科', '保利', '华侨城']),
    ('医药',   ['医药', '医疗', '生物', '制药', '药业', '医院', '康', '健康', '疫苗']),
    ('食品饮料', ['茅台', '啤酒', '白酒', '食品', '饮料', '乳业', '牛奶', '调味', '海天', '伊利', '蒙牛']),
    ('汽车',   ['汽车', '客车', '整车', '零部件', '比亚迪']),
    ('电子',   ['电子', '半导体', '芯片', '集成电路', '显示', '光学', '传感']),
    ('计算机', ['软件', '信息', '科技', '网络', '数据', '用友', '东方财富', '恒生']),
    ('通信',   ['通信', '联通', '移动', '电信', '中兴']),
    ('电力',   ['电力', '水电', '核电', '风电', '光伏', '能源', '电网', '国电', '华电', '华能', '浙能']),
    ('新能源', ['通威', '隆基', '阳光电源', '宁德', '亿纬', '比亚迪']),
    ('化工',   ['化工', '化学', '石化', '化纤', '树脂', '轮胎', '农药']),
    ('钢铁',   ['钢铁', '钢股', '钢业', '宝钢', '包钢', '鞍钢', '华菱']),
    ('有色金属', ['铜业', '铝业', '黄金', '稀土', '锂', '钴', '镍', '锌']),
    ('煤炭',   ['煤炭', '煤业', '能源', '兖矿', '陕西煤', '中煤']),
    ('石油',   ['石油', '石化', '中国海油', '中国石油', '中国石化']),
    ('建材',   ['水泥', '玻璃', '建材', '巨石', '海螺']),
    ('建筑',   ['建筑', '建设', '路桥', '工程', '中建', '中铁']),
    ('军工',   ['航空', '航天', '船舶', '军工', '兵器', '中航', '中船', '动力']),
    ('交通运输', ['机场', '港口', '高速', '航运', '物流', '快递', '铁路', '海运']),
    ('农业',   ['农业', '农牧', '种业', '畜牧', '水产', '林业']),
    ('家电',   ['家电', '电器', '空调', '冰箱', '洗衣', '美的', '格力', '海尔']),
    ('纺织服装', ['纺织', '服装', '服饰', '制衣']),
    ('传媒',   ['传媒', '媒体', '影视', '广告', '出版', '文化']),
]
